...
const state = {
    ...
    socketGeneral: socketIo(process.env.VUE_APP_SOCKET_URL+'/general', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']}),
    socketCrash: socketIo(process.env.VUE_APP_SOCKET_URL+'/crash', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']}),
    socketRoll: socketIo(process.env.VUE_APP_SOCKET_URL+'/roll', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']}),
    socketBlackjack: socketIo(process.env.VUE_APP_SOCKET_URL+'/blackjack', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']}),
    socketDuels: socketIo(process.env.VUE_APP_SOCKET_URL+'/duels', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']}),
    socketMines: socketIo(process.env.VUE_APP_SOCKET_URL+'/mines', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']}),
    socketTowers: socketIo(process.env.VUE_APP_SOCKET_URL+'/towers', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']}),
    socketUnbox: socketIo(process.env.VUE_APP_SOCKET_URL+'/unbox', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']}),
    socketBattles: socketIo(process.env.VUE_APP_SOCKET_URL+'/battles', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']}),
    socketUpgrader: socketIo(process.env.VUE_APP_SOCKET_URL+'/upgrader', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']}),
    socketCashier: socketIo(process.env.VUE_APP_SOCKET_URL+'/cashier', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']}),
    socketAdmin: socketIo(process.env.VUE_APP_SOCKET_URL+'/admin', { auth: {}, autoConnect: false, reconnection: true, reconnectionDelay: 5000, transports: ['polling', 'websocket']})
}
